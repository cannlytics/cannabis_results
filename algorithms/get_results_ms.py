...
Description:
    ...
    Collect all public Mississippi lab result data.
...
avg_thc_by_lab.columns = ['Lab ID', 'Average Total THC (%)']
avg_thc_by_lab['Average Total THC (%)'] = avg_thc_by_lab['Average Total THC (%)'].map('{:.2f}'.format)
